...
const environment =
  EnvironmentVariablesManager.getEnvVariable('DATABASE_ENVIRONMENT') === 'production'
    ? 'prod'
    : 'staging';

const fbCrRevealBotSheetId =
  environment === 'prod'
...
const tikTokCrRevealBotSheetId =
  environment === 'prod'
...
const tiktokFFSedoRevealbotSheetId =
  environment === 'prod'
