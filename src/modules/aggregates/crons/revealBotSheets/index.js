...
const { FACEBOOK_REVEALBOT_SHEET_REGULAR_CRON, TIKTOK_REVEALBOT_SHEET_REGULAR_CRON } = require("./rules");
...
const disableRevealBotSheetCron =
  process.env.DISABLE_REVEALBOT_SHEET_CRON === "true" || process.env.DISABLE_REVEALBOT_SHEET_CRON !== "false";
const revealBotSheetService = new RevealBotSheetService();

const updateFacebookRevealBotSheetRegular = new CronJob(FACEBOOK_REVEALBOT_SHEET_REGULAR_CRON, async () => {
...
const updateTikTokRevealBotSheetRegular = new CronJob(TIKTOK_REVEALBOT_SHEET_REGULAR_CRON, async () => {
