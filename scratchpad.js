...
// ACCOUNTING ROUTES - CROSSROADS
// There might be some further refactoring in function of the display

// Total by traffic source agg by day
...
// Total by media buyer agg by day
...
// ACTIVITY REPORTS ROUTES - CROSSROADS

// Find media buyers activity in terms of campaigns created, budget adjusted, and campaigns paused
...
const main = async () => {
  ...
  // const { rows } = await mediaBuyersActivityCrossroads('2023-06-27', '2023-07-02')
  // const { rows } = await crossroadsTotals('2023-06-27', '2023-07-02')
  const { rows } = await crossroadsTotalsByMediaBuyer('2023-06-27', '2023-07-02')
  console.log(rows)
}
